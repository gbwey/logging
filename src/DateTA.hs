...
#ifdef mingw32_HOST_OS
dt1, dt2, dt3 :: SYSTEMTIME
dt1 = SYSTEMTIME {wYear = 2020, wMonth = 5, wDayOfWeek = 1, wDay = 11, wHour = 12, wMinute = 48, wSecond = 43, wMilliseconds = 123}
dt2 = SYSTEMTIME {wYear = 2020, wMonth = 1, wDayOfWeek = 1, wDay = 11, wHour = 12, wMinute = 48, wSecond = 43, wMilliseconds = 1}
dt3 = SYSTEMTIME {wYear = 2020, wMonth = 12, wDayOfWeek = 1, wDay = 1, wHour = 1, wMinute = 2, wSecond = 3, wMilliseconds = 0}
